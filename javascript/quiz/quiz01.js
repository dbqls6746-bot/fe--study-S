...
console.log(getMealByTime2(5)); 
console.log(getMealByTime2(8)); 
console.log(getMealByTime2(13)); 
console.log(getMealByTime2(16)); 
console.log(getMealByTime2(19)); 
console.log(getMealByTime2(22)); 
console.log(getMealByTime2(2)); 
console.log('----------------------------------')
...
const getMealByTime3 = (time) =>
    ...
    (time>=11 && time <=14) ? '점심' :
    (time>=17 && time <=20) ? '저녁' :
    (time>=21 && time <=23) ? '야식' : '금식';

console.log(getMealByTime3(5)); 
console.log(getMealByTime3(8)); 
console.log(getMealByTime3(13)); 
console.log(getMealByTime3(16)); 
console.log(getMealByTime3(19)); 
console.log(getMealByTime3(22)); 
console.log(getMealByTime3(2)); 